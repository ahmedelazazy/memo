          ...
          $('#builder_export')
            ...
            .click(function(a) {
              a.preventDefault(),
                (e = $(this)),
                t.isVerified() ||
                  ($('#m-modal-purchase').modal('show'), $('#alert-message').addClass('m--hide'), grecaptcha.reset());
            }),
          $('#submit-verify').click(function(a) {
            a.preventDefault(),
              t.reCaptchaVerified().done(function(t) {
                t.success
                  ? ($('[data-dismiss="modal"]').trigger('click'), $(e).trigger('click'))
                  : (grecaptcha.reset(),
                    $('#alert-message')
                      .removeClass('alert-success m--hide')
                      .addClass('alert-danger')
