  ...
  function c(c) {
    return this.each(function() {
      var d = a(this),
        ...
        f = 'object' == typeof c && c;
      (e || 'destroy' != c) &&
        (e || d.data('multiselectsplitter', (e = new b(this, f))), 'string' == typeof c && e[c]());
    });
  }
  var b = function(a, b) {
  ...
  (b.DEFAULTS = {
    ...
    (b.prototype.init = function(c, d, e) {
      ...
      (f.type = c),
        ...
        (f.$wrapper = f.$element.next('div[data-multiselectsplitter-wrapper-selector]')),
        (f.$firstSelect = a('select[data-multiselectsplitter-firstselect-selector]', f.$wrapper)),
        (f.$secondSelect = a('select[data-multiselectsplitter-secondselect-selector]', f.$wrapper));
      var g = 0,
        h = 0;
      if (0 != f.$element.find('optgroup').length) {
        ...
        (i = Math.min(i, 10)),
          f.options.selectSize
            ...
            : f.options.maxSelectSize && (i = Math.min(i, f.options.maxSelectSize)),
          f.$firstSelect.attr('size', i),
          f.$secondSelect.attr('size', i),
          f.$element.attr('multiple') && f.$secondSelect.attr('multiple', 'multiple'),
            ...
            if (!(f.$element.find('option').length < 1)) {
              ...
              (b = a.length
                ...
                : f.$element
                    ...
                    .parent()
                    .attr('label')),
                f.$firstSelect.find('option[value="' + b + '"]').prop('selected', !0),
                f.$firstSelect.trigger('change');
            }
          }),
          f.update(),
          (f.initialized = !0),
          f.options.afterInitialize && f.options.afterInitialize(f.$firstSelect, f.$secondSelect);
      }
    }),
    ...
    (b.prototype.createSecondSelect = function() {
      ...
      b.$secondSelect.empty(),
        a.each(b.$element.find('optgroup[label="' + b.$firstSelect.val() + '"] option'), function(c, d) {
          var e = a(this).val(),
            f = a(this).text(),
    ...
    (b.prototype.updateParentCategory = function() {
      ...
      (a.last$ElementSelected = a.$element.find('option:selected')),
        a.options.clearOnFirstChange && a.initialized && a.$element.find('option:selected').prop('selected', !1),
        ...
        if (
          ...
          if (d.length > c) {
            b.$firstSelect.find('option:selected').prop('selected', !1),
              ...
              b.initialized
                ? (b.$element.find('option:selected').prop('selected', !1), b.last$ElementSelected.prop('selected', !0))
            ...
            var e = b.last$ElementSelected
              ...
              .parent()
              .attr('label');
            b.$firstSelect.find('option[value="' + e + '"]').prop('selected', !0),
    ...
    (b.prototype.updateChildCategory = function(b) {
      'change' == b.type
        ...
        : 'click' == b.type && (clearTimeout(this.timeOut), this.basicUpdateChildCategory(b, b.ctrlKey));
    }),
