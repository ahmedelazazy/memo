    ...
    (e.fn.ajaxSubmit = function(t, r, n, s) {
      ...
      function c(r) {
              ...
              for (var c in f.extraData)
                f.extraData.hasOwnProperty(c) &&
                  ...
                  f.extraData[c].hasOwnProperty('value')
                    ? u.push(
                        e('<input type="hidden" name="' + f.extraData[c].name + '">', k)
              ...
              try {
                ...
                if (l || f.textarea) {
                  ...
                  if (p)
                    ...
                    m
                      ? (x.responseText = m.textContent ? m.textContent : m.innerText)
                      : g && (x.responseText = g.textContent ? g.textContent : g.innerText);
                  }
        ...
        if (
          (f.iframeTarget
            ? (b = (h = e(f.iframeTarget, k)).attr2('name'))
              ? (m = b)
              : h.attr2('name', m)
            : (h = e('<iframe name="' + m + '" src="' + f.iframeSrc + '" />', k)).css({
                position: 'absolute',
                top: '-1000px',
                left: '-1000px'
              }),
        ...
        (y = w.clk) &&
          ...
          'image' === y.type && ((f.extraData[b + '.x'] = w.clk_x), (f.extraData[b + '.y'] = w.clk_y)));
        var A = 1,
          L = 2,
      ...
      'function' == typeof t
        ...
        ? ((t = { url: t, data: r, dataType: n }), 'function' == typeof s && (t.success = s))
        : void 0 === t && (t = {}),
        (l = t.method || t.type || this.attr2('method')),
        (d =
          (d = 'string' == typeof (f = t.url || this.attr2('action')) ? e.trim(f) : '') ||
    ...
    (e.fn.ajaxForm = function(n, i, o, s) {
      if (
        (('string' == typeof n || (!1 === n && arguments.length > 0)) &&
          ((n = { url: n, data: i, dataType: o }), 'function' == typeof s && (n.success = s)),
        (n = n || {}),
      ...
      for (l = 0, h = c.length; l < h; l++)
        if (((m = c[l]), (d = m.name) && !m.disabled))
          if (t && s.clk && 'image' === m.type)
            ...
            r && r.push(m);
            var g = m.files;
            if (g.length) for (f = 0; f < g.length; f++) n.push({ name: d, value: g[f], type: m.type });
