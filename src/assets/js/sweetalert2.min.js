!(function(e, t) {
  ...
  var q =
    ...
    $ = function(e) {
      ...
      if (
        ...
        e.showConfirmButton
          ? ((n = 'display'), (t = r).style.removeProperty ? t.style.removeProperty(n) : t.style.removeAttribute(n))
          : U(r),
      ...
      if (t) {
        ...
        var r = function() {
          ...
          T() ||
            ...
            L() &&
              (null !== m.previousBodyPadding &&
                ((document.body.style.paddingRight = m.previousBodyPadding), (m.previousBodyPadding = null)),
              (function() {
              ...
              o(t, [
                {
                  key: '_main',
                  value: function(e) {
                    return i(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), '_main', this).call(
                      this,
                      r({}, n, e)
                    );
                  }
  ...
  function ye() {
    ...
    e.showConfirmButton || (U(t.confirmButton), e.showCancelButton || U(t.actions)),
  ...
  var xe = Object.freeze({
      ...
      _main: function(e) {
        ...
        !(function(t) {
          ...
          if (
            ...
            'string' == typeof t.backdrop
              ...
              : t.backdrop || R([document.documentElement, document.body], I['no-backdrop']),
            !t.backdrop &&
              t.allowOutsideClick &&
              d('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
            t.position in I
              ? R(s, I[t.position])
              : (d('The "position" parameter is not valid, defaulting to "center"'), R(s, I.center)),
          ...
          'function' == typeof t.animation && (t.animation = t.animation.call()),
            t.showCloseButton ? (u.setAttribute('aria-label', t.closeButtonAriaLabel), z(u)) : U(u),
            (e.className = I.popup),
        ...
        return new Promise(function(t, n) {
                  ...
                  if ((t.stopKeydownPropagation && e.stopPropagation(), 'Enter' !== e.key || e.isComposing))
                    if ('Tab' === e.key) {
                      ...
                      ['ArrowLeft', 'ArrowRight', 'ArrowUp', 'ArrowDown', 'Left', 'Right', 'Up', 'Down'].indexOf(e.key)
                        ? document.activeElement === j.confirmButton && F(j.cancelButton)
                          ? j.cancelButton.focus()
                          : document.activeElement === j.cancelButton && F(j.confirmButton) && j.confirmButton.focus()
          ...
          for (
            var d = ['input', 'file', 'range', 'select', 'radio', 'checkbox', 'textarea'], p = void 0, f = 0;
            f < d.length;
            f++
          ) {
            var m = I[d[f]],
          ...
          if ('select' === T.input || 'radio' === T.input) {
            ...
            H(T.inputOptions)
              ...
              ? O(T.inputOptions)
              : V('Unexpected type of inputOptions! Expected object, Map or Promise, got ' + q(T.inputOptions));
          } else
