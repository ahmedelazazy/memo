jQuery.validator.setDefaults({
  ...
  errorPlacement: function(error, element) {
    ...
    var group =
      $(element).closest(".m-form__group-sub").length > 0
        ? $(element).closest(".m-form__group-sub")
        : $(element).closest(".m-form__group");
  ...
  success: function(label, element) {
    var group =
      $(label).closest(".m-form__group-sub").length > 0
        ? $(label).closest(".m-form__group-sub")
        : $(label).closest(".m-form__group");
