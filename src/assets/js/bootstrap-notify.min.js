      ...
      placement: function() {
        ...
        switch (
          (a(
            ...
            return (c = Math.max(
              c,
              parseInt(a(this).css(f.placement.from)) + parseInt(a(this).outerHeight()) + parseInt(f.spacing)
            ));
          }),
        ...
        this.$ele.css(d).addClass(this.settings.animate.enter),
          ...
          1 == this.settings.newest_on_top &&
            ((c = parseInt(c) + parseInt(this.settings.spacing) + this.$ele.outerHeight()), this.reposition(c)),
      ...
      bind: function() {
        ...
        if (
          ...
          var c = setInterval(function() {
            ...
            if (
              ('false' === b.$ele.data('data-hover') && 'pause' == b.settings.mouse_over) ||
